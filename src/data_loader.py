...
class Dataset(data.Dataset):
    ...
    def __init__(self, pairs, src_word2id, trg_word2id):
        """Reads source and target sequences from txt files."""
        self.src_seqs = pairs[:, 0]
        self.trg_seqs = pairs[:, 1]
...
def collate_fn(data):
    ...
    return src_seqs.transpose(0, 1), src_lengths, trg_seqs.transpose(0, 1), trg_lengths


def get_loader(pairs, src_word2id, trg_word2id, batch_size=100):
    ...
    dataset = Dataset(pairs, src_word2id, trg_word2id)
